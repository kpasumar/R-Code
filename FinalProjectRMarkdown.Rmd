...
Now take a look at pair plots of all numeric variates i.e. all variates excluding logical variates such as \texttt{cursmoke}. 
...
However, we end up getting NAs in the coefficients for two interactions \texttt{cursmoke:cigpday} and \texttt{bpmeds:prevhyp}.
...
To fix these we remove these two interactions from Mmax and add some quadratic terms for continuous variates in hope of having some additional predicitive power.
